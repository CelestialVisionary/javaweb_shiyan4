...
public class CakeDB {
    ...
    static {
        cake.put("1", new Cake("1", "A类蛋糕", 19.9));//直接调用构造方法构建一个Cake的实例，并设置价格
        cake.put("2", new Cake("2", "B类蛋糕", 29.9));
        cake.put("3", new Cake("3", "C类蛋糕", 39.9));
        cake.put("4", new Cake("4", "D类蛋糕", 49.9));
        cake.put("5", new Cake("5", "E类蛋糕", 59.9));
    }
